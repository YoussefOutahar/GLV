...
public class ModifyUserFrame extends JFrame {
    ...
    public ModifyUserFrame(Admin admin) {
        ...
        signUpButton.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                boolean accountModified = UsersController.modifyAdmin(admin.getId(), loginTextField.getText(), String.valueOf(passwordField.getPassword()), image, emailTextField.getText(), phoneNumberTextField.getText());
                if (accountModified) {
    ...
    public ModifyUserFrame(User user) {
        ...
        signUpButton.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                //boolean accountModified = DBmodify.modifyUser();
                boolean accountModified = UsersController.modifyUser(user.getId(), loginTextField.getText(), String.valueOf(passwordField.getPassword()), image, emailTextField.getText(), phoneNumberTextField.getText());
                if (accountModified) {
                    CurrentSession.setSession(loginTextField.getText(), String.valueOf(passwordField.getPassword()));
    ...
    public static void initIcons(boolean isDark){
        if(isDark){
            uploadPictureHolder.setIcon(new ImageIcon(ModifyUserFrame.class.getResource("/GUI/resources/black_icons/user-big.png")));
            exitButton.setIcon(new ImageIcon(ModifyUserFrame.class.getResource("/GUI/resources/black_icons/cross.png")));
            uploadPicButton.setIcon(new ImageIcon(ModifyUserFrame.class.getResource("/GUI/resources/black_icons/upload.png")));
        }else{
            uploadPictureHolder.setIcon(new ImageIcon(ModifyUserFrame.class.getResource("/GUI/resources/white_icons/user-big.png")));
            exitButton.setIcon(new ImageIcon(ModifyUserFrame.class.getResource("/GUI/resources/white_icons/cross.png")));
            uploadPicButton.setIcon(new ImageIcon(ModifyUserFrame.class.getResource("/GUI/resources/white_icons/upload.png")));
        }
    }

    private void initComponents() {

        signUpButton = new GLVButton("Modify",30, 30, Color.white,Color.gray);
    ...
    public static void startModifyUserFrame(User user,Color color) {
