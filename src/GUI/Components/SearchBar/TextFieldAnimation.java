package GUI.Components.SearchBar;
...
public class TextFieldAnimation extends JTextField {
    ...
    public TextFieldAnimation() {
        ...
        iconSearch = new ImageIcon(getClass().getResource("/GUI/Components/SearchBar/search.png"));
        iconClose = new ImageIcon(getClass().getResource("/GUI/Components/SearchBar/close.png"));
        iconLoading = new ImageIcon(getClass().getResource("/GUI/Components/SearchBar/loading.gif"));
